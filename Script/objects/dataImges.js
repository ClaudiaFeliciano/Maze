var objects;
(function (objects) {
    var DataImage = /** @class */ (function () {
        function DataImage() {
            this.context = managers.GlobalVariableGame.canvas.getContext("2d");
            this.maze = managers.GlobalVariableGame.maze;
        }
        DataImage.prototype.canMoveTo = function (destX, destY) {
    ...
    objects.DataImage = DataImage;
})(objects || (objects = {}));
//# sourceMappingURL=dataImges.js.map